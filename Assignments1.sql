...
VALUES (1,'Bhaskar','Kumar','Ananthapur','INDIA','88354543390'),
(2,'simran','kumari','Kurnool','INDIA','8739293390'),
(3,'Sujeet','dubey','Bihar','INDIA','7240074321'),
(4,'Priyanka','Joshi','Delhi','INDIA','8894561230'),
(5,'Rahul','Kumar','Banglore','INDIA','8834567890');


INSERT INTO dbo.Customer(CustomerId,FirstName,LastName,City,Country,Phone)
VALUES (6,'David','Gorege','TEXAS','USA','0321456789'),
(7,'Krishna','Raju','MUMBAI','INDIA','8639593390');
